  ...
  */
        const { config: setOpenPositionLongConfig } = usePrepareContractWrite({
          ...
          */
          ...
          const { data: readAllowanceData, refetch: readAllowanceRefetch } =
            useContractRead({
          ...
          */
          const { config: setDepositConfig } = usePrepareContractWrite({
            ...
            args: [XUSD_ADDRESS, ethers.utils.parseEther(amountDeposit || "0")],
          });
          ...
          */
          ...
          const { config: setWithdrawConfig } = usePrepareContractWrite({
            ...
            args: [XUSD_ADDRESS, ethers.utils.parseEther(amountWithdraw || "0")],
          });
